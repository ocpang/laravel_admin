    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="text-center">
                <img class="profile-user-img img-fluid img-circle" src="{{ Auth::user()->avatar == '' ? asset('images/defaultuser.jpeg') : asset('images/avatars/' . Auth::user()->avatar) }}" alt="User profile picture">
            </div>
